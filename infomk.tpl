	...
	<div class="container-fluid my-2" style="width: 80%">
		...
		<form class="" method="post">
			<div class="row">
				...
				<div class="form-group col-sm-2 align-self-end" style="/*display: none;*/">
				...
				<div class="form-group col-sm align-self-end">
						<label for="r_limit">Минимальный коэффициент:</label>
						%if 'min_sfr' in stat:
			...
			<div class="row">
				...
				<div class="form-group col-sm-3 align-self-center" style="/*display: none;*/">
						<label for="v_num">Число строк по вертикали:</label>
				</div>
				...
				<div class="form-group col-sm align-self-center">
						<label for="r_limit">Количество результатов:</label>
				</div>
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="row justify-content-start">
							...
							<div class="col-sm" id="label_win">{{stat["win"]}}</div>
						</div>
						<div class="row justify-content-start">
							<div class="col-sm">Проигрыш:</div>
							<div class="col-sm" id="label_lose">{{stat["total"] - stat["win"]}}</div>
						</div>
						<div class="row justify-content-start">
